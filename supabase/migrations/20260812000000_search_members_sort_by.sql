-- Add sort_by to directory search RPCs.

DROP FUNCTION IF EXISTS search_alumni(text, uuid, uuid, uuid, uuid, uuid, int, int);
...
GRANT EXECUTE ON FUNCTION search_members(text, uuid, uuid, boolean, uuid, uuid, uuid, int, int, text) TO authenticated;
...
GRANT EXECUTE ON FUNCTION search_alumni(text, uuid, uuid, uuid, uuid, uuid, int, int, text) TO authenticated;
