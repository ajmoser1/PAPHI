...
const PROFILE_EDIT_SELECT =
  'id, first_name, last_name, role, status, chapter_id, avatar_url, bio, graduation_year, chapter, visibility_scope, privacy_settings, search_scope, featured_position_id' as const
